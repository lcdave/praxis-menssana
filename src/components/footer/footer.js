          ...
          <div className="columns is-desktop">
            ...
            <div className="column">
              <div className="footer__phone">
                <FaPhone />{" "}
                <span className="footer__phone-label">+41 (0)79 470 87 77</span>
              </div>
            </div>
            <div className="column">
        ...
        <div className="container">
          <div className="columns is-desktop">
            ...
            <div className="column">
              ...
              <p className="footer__link">
                <Link to="/selbstbewusstsein-ich-staerkung">
        ...
        <div className="container">
          <div className="columns is-mobile">
            <div className="column is-four-fifths-desktop">
              <Link to="/datenschutz" className="service-navigation__link">
                Datenschutz
              </Link>
              <Link to="/impressum" className="service-navigation__link">
                Impressum
              </Link>
              <Link to="/relevante-seiten" className="service-navigation__link">
                Relevante Seiten
              </Link>
            </div>
            <div className="column">
              <div className="service-navigation__social">
                <a
                  href="https://www.facebook.com/Hypnosepraxis-Menssana-105571791009303/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <FaFacebook />
                ...
                <a
                  href="https://www.instagram.com/hypnosepraxis_menssana/"
                  target="_blank"
                  rel="noreferrer"
                >
                  <FaInstagram />
