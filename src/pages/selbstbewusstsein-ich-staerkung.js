...
const SelbstbewusstseinIchStaerkung = (props) => {
...
export default SelbstbewusstseinIchStaerkung

export const query = graphql`
    query {
        allFile(filter: {sourceInstanceName: {eq: "content"} name: {eq: "selbstbewusstsein-ich-staerkung"}}) {
            edges {
                node {
                    childMarkdownRemark {
                        frontmatter {
